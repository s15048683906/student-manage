...
<html>
  ...
  <body>
  <div class ="div_title">
		 <div class="div_titlename"> <img src="images/san_jiao.gif" ><span>班级管理 专业维护</span></div>
	 </div>
				 
	 <form action="Class_Servlet" method="post" >
	 	 <input name="flag" value="addMajor" type="hidden" >
		 <table class="edit_table" >
		 		<tr>
		 			 	<td class="td_info">专业名称：</td>	
